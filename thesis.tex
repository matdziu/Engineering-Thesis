...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{world_cnns}
\centering
...
\begin{figure}[h]
\includegraphics[width=0.7\textwidth]{worse_net}
\centering
...
\centering
\caption{Manually collected data set for Harnas beer label class. The first picture (2160 x 3840 pixels resolution) was taken by camera and the second one (ideal) was found on the internet.}
...
\centering
\caption{Small portion of augmented training set for Harnas beer label class.}
...
\begin{figure}[h]
\includegraphics[width=0.6\textwidth]{10_class_acc}
\centering
