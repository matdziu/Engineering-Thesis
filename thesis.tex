...
\addto\captionsenglish{%
  \renewcommand{\listfigurename}{Spis rysunków - tłumaczenie}
}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Podstawowe informacje}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Definicja problemu}
...
\centering
\caption[Duża półka z piwami]{A large beer shelf. Source: \protect \url{http://trib.com}.}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Ogólny przegląd rozwiązania}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Rozwiązania powiązane}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Wprowadzenie do sztucznej inteligencji}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Wprowadzenie do sieci neuronowych}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Wprowadzenie do konwolucyjnych sieci neuronowych}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Porównanie najlepszych konwolucyjnych sieci neuronowych}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Technika transfer learning}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Augmentacja danych}
...
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Szczegółowy przegląd rozwiązania}
...
\centering
\caption[Widok serwera od strony terminala]{Terminal view of requests sent to Flask server (to "/predict" endpoint) from Android application. "200" return code indicates that request succeeded.}
...
\section{Necessary translations} \label{necessary_trans}
\addcontentsline{tos}{section}{\protect\numberline{\thesection} Wymagane tłumaczenia}
Ta sekcja stanowi podsumowanie najważniejszych informacji dotyczących zaprezentowanej pracy dyplomowej.\\

\begin{enumerate}
\item \textbf{Definicja problemu.}\\
Przyspieszenie dostępu użytkownika do bazy danych piwa przy wykorzystaniu wizji komputerowej i urządzenia mobilnego.

\item \textbf{Cel utylitarny.}\\
Zaprojektowanie i implementacja systemu typu serwer-klient służącego do ropoznawania etykiet piwa.

\item \textbf{Cele poznawcze.}
	\begin{enumerate}
	\item Badanie wpływu architektury konwolucyjnej sieci neuronowej (KSN) i augmentacji danych na dokładność i czas trenowania rozpoznawarki.
	\item Zyskanie głębszego zrozumienia problemu wizji komputerowej przy użyciu KSN.
	\item Znalezienie minimalnej ilości iteracji treningowych i danych potrzebnych w celu osiągnięcia skuteczności rozpoznania nie mniejszej niż 85\%.
	\end{enumerate}

\item \textbf{Zakres.}
	\begin{enumerate}
	\item Implementacja skryptu do augmentacji danych.
	\item Implementacja skryptu do uzyskiwania tzw. bottleneck features i trenowania konwolucyjnej sieci neuronowej.
	\item Implementacja serwera REST do wysyłania predykcji.
	\item Impementacja aplikacji na Androida, pozwalającej na robienie zdjęć i wysyłanie ich na serwer.
	\end{enumerate}
